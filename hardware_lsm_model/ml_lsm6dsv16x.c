...
void LSM6DSV16X_Write(uint8_t addr, uint8_t Data)
{
    //uint8_t data[2] = {LSM6DSV16X_ADDR,Data};
    I2C_Write(LSM6DSV16X_ADDR, addr, &Data, 1);
...
{
    uint8_t data[2];
    I2C_Read(LSM6DSV16X_ADDR, addr, &data[1], 1);
    return data[1];
}
